...
« Le Federated Learning (FL) représente une avancée significative dans la gestion sécurisée » ([Nikabou, 2025, p. 5](zotero://select/library/items/DAD7MWVZ)) ([pdf](zotero://open-pdf/library/items/TB6KCMI6?page=5&annotation=QKU6TETH)) C'est le pivot technologique qui permet de réconcilier Big Data et secret médical.

« La valorisation du « savoir expérientiel » souligne l’importance d’impliquer activement les patients » ([Nikabou, 2025, p. 7](zotero://select/library/items/DAD7MWVZ)) ([pdf](zotero://open-pdf/library/items/TB6KCMI6?page=7&annotation=WL5LJ86P)) L'éthique du Care transforme le patient d'objet d'étude en partenaire de soin.

« L’opacité des algorithmes risque de saper la confiance des utilisateurs et de compliquer la tâche des régulateurs pour identifier les défaillances potentielles. » ([Nikabou, 2025, p. 8](zotero://select/library/items/DAD7MWVZ)) ([pdf](zotero://open-pdf/library/items/TB6KCMI6?page=8&annotation=PBPNXA2H)) L'opacité n'est pas une fatalité technique , on doit exiger une "IA explicable" dès la conception (*Explainable AI*)
